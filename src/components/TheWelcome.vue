...
<template>
  ...
  >
    <div>
      <div class="test text-xl font-medium text-black">ChitChat</div>
      <p class="hello text-gray-500">You have a new <span>message!</span></p>
    </div>
  </div>
...
<style lang="scss">
@import url('sass/TheWelcome.scss');
